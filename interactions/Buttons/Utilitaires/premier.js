...
module.exports = {
    ...
    async button(interaction) {
        ...
        LUN.db.logs(3, "Bouton - Premier", `Génération du détails du match Premier (${matchId})`)
        ...
        if (fs.existsSync(`assets/matchDetails/${matchId}-details.png`)) {
            try {
                ...
                LUN.db.logs(1, "Bouton - Premier", e)
            }
        }
        ...
        allyIcon.resize(600,600)
        enemyIcon.resize(600,600)
        premierIcon.resize(100,100)

        premierIcon.opacity(.3)
        allyIcon.opacity(.3)
        enemyIcon.opacity(.3)
        ...
        base.composite(allyIcon, (base.getWidth() / 4)-300, (base.getHeight() / 2)-300)
        base.composite(enemyIcon, (base.getWidth() / 4)*3-300, (base.getHeight() / 2)-300)
